...
export function queryBrand(param){
	...
	return (dispatch) => {
		requestData("http://api3.bestinfoods.com/item/get/goodsbybrandid","POST",data)
		.then((data) => {
		...
		requestData("http://api3.bestinfoods.com/item/get/goodsbybrandid", "POST", 'brandId=' + param + '&tagType=1')
		.then((data) => {
...
export function resetBrandData (){
	return {
		type : Types.RESETBRANDDATA
	}
}