...
export function queryShoppingCartData() {
    return ((dispatch) => {
        requestData('http://api3.bestinfoods.com/order/get/showcart', 'POST')
        .then((successData) => {
...
function queryShoppingCartDataNext() {
    return ((dispatch) => {
        requestData('http://api3.bestinfoods.com/order/get/showcart', 'POST')
        .then((successData) => {
            if (0 === successData.errorcode) {
...
export function goodsCheckBoxClicked(goodsId) {
    return ((dispatch) => {
        ...
        requestData('http://api3.bestinfoods.com/order/put/updatecart', 'POST', 'goods=' + param)
        .then((successData) => {
            if (0 === successData.errorcode) {
                dispatch(queryShoppingCartDataNext());
            } else {
...
export function checkAllCheckBoxClicked(checkState) {
    var param = 'select';
    ...
    return ((dispatch) => {
        ...
        requestData('http://api3.bestinfoods.com/order/put/updatecart', 'POST', 'operation=' + param)
        .then((successData) => {
            if (0 === successData.errorcode) {
                dispatch(queryShoppingCartDataNext());
            } else {
...
export function amountPlusClicked(goodsId, goodsAmount) {
    return ((dispatch) => {
        var param = [];
        var goodsParam = {
            goodsId: goodsId,
...
export function amountMinusClicked(goodsId, goodsAmount) {
    return ((dispatch) => {
        var param = [];
...
export function deleteGoods(goodsId) {
    return ((dispatch) => {
        ...
        requestData('http://api3.bestinfoods.com/order/delete/deletecart', 'POST', 'goods=' + param)
        .then((successData) => {
            if (0 === successData.errorcode) {
                dispatch(queryShoppingCartDataNext());
            } else {
