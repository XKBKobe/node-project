...
import { hashHistory, Actions } from 'react-native-router-flux';
...
export default class BaseComponent extends Component {
    ...
    headerLeftRender(isBackShow) {
        if (isBackShow) {
            return <View onClick={() => hashHistory.goBack()} style={styles.headerLeftView}>
    ...
    headerMiddleRender(headerName) {
        return <View style={styles.headerTitleContentView}>
