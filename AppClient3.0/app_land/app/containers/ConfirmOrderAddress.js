    ...
    addressItemRender() {
        return this.props.addressListState.addressListData.data.map((addressItem, index) => {
            ...
            return <View key={index}>
                    <View style={confirmStyles.itemAddress_D}>

                        <View style={confirmStyles.checkboxAddress_D}>
                            {this.chooseShowRender(isChoose)}
                        </View>

                        <View style={confirmStyles.itemAddressTwo_D} onClick={() => this.props.addressListActions.addressItemClick(addressItem.address_id)}>
