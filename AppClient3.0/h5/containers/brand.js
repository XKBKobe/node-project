...
import { queryBrand , resetBrandData } from '../../common/actions/brandAction';
...
class Brand extends baseComponent {
	...
	render () {
		...
		var headerParam = {
	      	isHeaderShow: true,
	      	headerName: this.props.location.query.brandName,
	      	isBackShow: true
    	};
...
function mapDispatchToProps(dispatch){
	return {
		...
		resetBrandData : bindActionCreators(resetBrandData,dispatch),
	}
}
