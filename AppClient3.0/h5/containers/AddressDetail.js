...
class AddressDetail extends BaseComponent {
    ...
    constructor(props) {
        ...
        this.selectProCityCounty = this.selectProCityCounty.bind(this)
    }
    ...
    chooseAddressItem(listObj){
        ...
        var objBg = {textColor: "#000000", bgColor: "#333333"};
            ...
            return <div>
                ...
                <div style={itemStyles.areaDetailContentView}>
                    ...
                    <div className = "swiper-container swiperBanner" style={itemStyles.scrollViewTwo}>
                        <div className = "swiper-wrapper" marginHeight={40}>
                            {
    ...
    hasDataRender(){
        ...
        var buttonStyle;
        if (this.state.onTouch1 && this.state.onTouch2){
            buttonStyle = itemStyles.saveAddressTrue_B;
        }else {
            buttonStyle = itemStyles.saveAddress_B;
        }
