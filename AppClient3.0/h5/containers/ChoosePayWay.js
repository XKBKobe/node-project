...
export default class ChoosePayWay extends BaseComponent {
    ...
    confirmPay() {
        ...
        if (this.state.isAlipayChoosed) {
            payWayUrl = 'http://v3.bestinfoods.com/malipay?orderId=' + this.props.location.query.orderSn;
        } else {
            payWayUrl = 'http://v3.bestinfoods.com/wechatpay?orderId=' + this.props.location.query.orderSn;
        }
        ...
        return (
            <div style = {styles.contentView}>
                <div style = {styles.priceBarView}>
                    <p style = {styles.textStyle1}>¥{this.props.location.query.totalPrice}</p>
