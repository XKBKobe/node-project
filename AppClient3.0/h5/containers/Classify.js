	...
	renderClassAList(typeCellData) {
		...
		return (
			<div style = { styles.goodsTypeItem }>
				<Link to = {{ pathname:"/search",query:{brandId: typeCellData.categoryId, categoryName: typeCellData.categoryName} }} >
	...
	renderClassBList(typesData) {
		...
		return (
			typesData.map(function(typeData,index){
				...
				return (
					<Link key = { index } to = {{ pathname:"/search",query:{brandId: typeData.categoryId, categoryName: typeData.categoryName} }}>
		...
		return (
			brandsData.map(function(brandData,index){
				return (
					<Link
						key = { index }
						to = {{pathname: "/brand", query:{brandId: brandData.brandId, brandName: brandData.brandName}}}>
	...
	renderGlobalList (countries) {
		...
		return (
			countries.map(function(country,index){
				return (
					<Link key = { index } to = {{ pathname:"/search",query:{countryId: country.countryId, categoryName: country.pavilionName} }}>
